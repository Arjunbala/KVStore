 ...
 *     return -1
 */
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_n_s_getValueForKey); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 40, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyBytes_FromString(__pyx_v_key); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 40, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_n_s_primary_server); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 40, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = NULL;
  __pyx_t_6 = 0;
  if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_2))) {
 ...
 * 
 */
  __pyx_t_8 = __Pyx_PyObject_AsString(__pyx_v_val); if (unlikely((!__pyx_t_8) && PyErr_Occurred())) __PYX_ERR(0, 41, __pyx_L1_error)
  (void)(strcpy(__pyx_v_value, __pyx_t_8));
